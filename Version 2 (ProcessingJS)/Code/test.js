//polygon
var array_polygon_test = [];
var pointer_polygon_test = null;

//polyline
var array_polyline_test = [];
var pointer_polyline_test = null;
...
function testData()
{
	...
	array_polylines_test = pointer_polylines_test;
	...
	array_polygons_test = pointer_polygons_test;
...
function test()
{
	...
	{
		var j=0;
		for(j=0; j<array_polylines_test[i].array_of_vectors.length; j++)
		{
