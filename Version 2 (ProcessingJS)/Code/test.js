...
function testData()
{
	...
	pointer_polygons_test = new Polygon(polygon9, "fill");
	...
	pointer_polygons_test = new Polygon(polygon10, "fill");
	...
	pointer_polygons_test = new Polygon(polygon11, "fill");
	...
	pointer_polygons_test = new Polygon(polygon12, "fill");
	...
	pointer_polygons_test = new Polygon(polygon13, "fill");
	...
	pointer_polygons_test = new Polygon(polygon14, "fill");
	...
	pointer_polygons_test = new Polygon(polygon15, "fill");
	...
	pointer_polygons_test = new Polygon(polygon16, "fill");
	...
	pointer_polygons_test = new Polygon(polygon17, "fill");
